...
CREATE FUNCTION "public"."match_documents"("query_embedding" "public"."vector", "match_count" integer, "filter" "jsonb" DEFAULT '{}'::"jsonb") RETURNS TABLE("id" bigint, "content" "text", "metadata" "jsonb", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
...
--
-- Name: ai_user_use; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."ai_user_use" (
    "id" "uuid" NOT NULL,
    "can_use" boolean DEFAULT false
);


ALTER TABLE "public"."ai_user_use" OWNER TO "postgres";
...
--
-- Name: ai_user_use ai_user_use_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."ai_user_use"
    ADD CONSTRAINT "ai_user_use_pkey" PRIMARY KEY ("id");
...
--
-- Name: ai_user_use ai_user_use_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."ai_user_use"
    ADD CONSTRAINT "ai_user_use_id_fkey" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."posts"
    ADD CONSTRAINT "posts_owner_fkey" FOREIGN KEY ("owner") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
--
-- Name: ai_user_use; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."ai_user_use" ENABLE ROW LEVEL SECURITY;

--
-- Name: users anyone can get user profile check; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "anyone can get user profile check" ON "public"."users" FOR SELECT USING (true);


--
-- Name: posts logged can get the posts; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "logged can get the posts" ON "public"."posts" FOR SELECT TO "authenticated" USING (true);


--
-- Name: users only know myself; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "only know myself" ON "public"."users" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "id"));


--
-- Name: posts owner can ctrl all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "owner can ctrl all" ON "public"."posts" TO "authenticated" USING (("owner" = "auth"."uid"())) WITH CHECK (("owner" = "auth"."uid"()));
...
--
-- Name: users update self; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "ai_user_use"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."ai_user_use" TO "anon";
GRANT ALL ON TABLE "public"."ai_user_use" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_user_use" TO "service_role";
