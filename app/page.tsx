    ...
    <div className='pt-2 justify-center items-center w-full text-center flex flex-col'>
      <div className="flex flex-col justify-center items-center text-left justify-items-center w-full py-2">
        <div className="flex flex-col justify-start py-10 mx-5">
          ...
          <p>if you any interest on my work, check my github profile. <u><a href="https://github.com/weykon">go!</a></u></p>
          <p>if you want to contact me, send me a email. <u><a href="mailto:weykon@qq.com">weykon@qq.com</a></u></p>
        </div>

        <ul className="dark:bg-slate-700 bg-slate-300 rounded-md w-80 border-2 border-neutral-400 p-2 text-slate-600">
      ...
      <div
        className="border-2 border-black text-black dark:border-gray-300 rounded-md my-8 w-auto px-4 h-16 items-center justify-center flex flex-col"
      >
        <Link
          href="weykon/posts"
        > read my posts </Link>
